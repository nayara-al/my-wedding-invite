export default function OurWedding() {
  return (
    <div className="flex justify-center items-center mb-[80px]">
      <div className="p-4 text-center bg-white w-[600px] rounded-2xl shadow-xl flex flex-col gap-4 mt-4">
        <header>
        ...
        <section>
          ...
          <p>
            Os noivos estão felizes em compartilhar esse
            momento especial com seus amigos e familiares. Eles se conheceram
            no dia 01/01/2020 e desde então compartilham uma linda jornada
            juntos.
          </p>
        </section>
        <section>
        ...
        <section>
          ...
          <p>
            Por favor, confirme sua presença até <strong>15/10/2024</strong> para que
            possamos fazer os preparativos necessários. Esperamos ansiosamente
            vê-lo no nosso casamento!
          </p>
        </section>
      </div>
    </div>
